...
function BranchesPage() {
  return (
    <div className="relative overflow-hidden py-14 sm:py-16 lg:py-20 bg-section-sapphire min-h-[calc(100vh-4rem)]">
      <span className="glow-orb top-[-10%] left-[-6%] h-96 w-96 bg-blue-600/18" aria-hidden="true" />
      <span className="glow-orb bottom-[-10%] right-[-5%] h-80 w-80 bg-violet-600/12" aria-hidden="true" />
