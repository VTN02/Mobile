...
const categoryMetadata: Record<Category, Omit<CategoryDetails, "name">> = {
  "Mobile Phones": {
    tagline: "Latest Flagship & Budget Smartphones",
    image: phonesImg,
    featuredTags: ["5G Flagships", "AMOLED 120Hz", "Triple Camera", "Long Battery"],
  ...
  "CCTV & Cameras": {
    ...
    popularBrands: ["Hikvision", "Imou", "CP Plus", "GoPro"],
  },
  "Chargers & Cables": {
    tagline: "GaN Fast Chargers & Heavy-Duty Power Cables",
    image: chargersImg,
    featuredTags: ["65W GaN Fast", "100W Braided", "USB-C PD", "3-in-1 Cables"],
    popularBrands: ["Anker", "Baseus", "Apple", "Samsung"],
  },
  "Repair Tools & Parts": {
    tagline: "Precision Toolkits, Meters & Repair Supplies",
    image: repairImg,
    featuredTags: ["128-in-1 Toolkits", "Digital Multimeter", "SMD Station", "B-7000 Glue"],
    popularBrands: ["Pro-Fix", "Fluke Pro", "Quick", "Zhanlida"],
  },
  "Electronics": {
    tagline: "Everyday Tech, Tablets & Computer Peripherals",
    image: electronicsImg,
    featuredTags: ["10\" Tablets", "Wireless Combos", "Desk Lighting", "Peripherals"],
    popularBrands: ["Samsung", "Xiaomi", "Logitech"],
  },
  "Accessories": {
    tagline: "Durable Protection, Mounts & Daily Gear",
    image: accessoriesImg,
    featuredTags: ["Shockproof Cases", "9H Glass", "Car Mounts", "Adapters"],
    popularBrands: ["Baseus", "Spigen", "Nillkin"],
  },
  "Audio": {
    tagline: "Wireless Earbuds, ANC & High-Fidelity Sound",
    image: audioImg,
    featuredTags: ["Active Noise Cancelling", "Deep Bass", "Bluetooth 5.3", "Waterproof"],
    popularBrands: ["Sony", "JBL", "Soundcore", "Apple"],
  },
  "Smart Watches": {
    tagline: "Fitness Trackers, Health Sensors & Smart Bands",
    image: watchImg,
    featuredTags: ["AMOLED Always-On", "Heart Rate & SpO2", "BT Calling", "Waterproof"],
    popularBrands: ["Samsung", "Apple", "Amazfit"],
  },
};
